...
EDIR_UPGRADE_SCRIPT="upgrade_cimitra_edir.sh"

GITHUB_EDIR_SCRIPT="https://raw.githubusercontent.com/cimitrasoftware/edir/main/cimitra_edir.sh"
GITHUB_EDIR_UPGRADE_SCRIPT="https://raw.githubusercontent.com/cimitrasoftware/edir/main/upgrade_cimitra_edir.sh"
...
{
dos2unix ${TEMP_FILE_DIRECTORY}/${EDIR_UPGRADE_SCRIPT}
} 1>> /dev/null 2>> /dev/null
